<?php
/**
 * inhabitent_Theme  functions and definitions.
 *
...
function inhabitent_scripts() {
	...
	wp_enqueue_script('inhabitent-font-awesome', 'https://use.fontawesome.com/107397f3e7.js',array(), '4.6.3',false);


	wp_enqueue_script('jquery');
	wp_enqueue_script('inhabitent-serch-secript', get_template_directory_uri() . '/build/js/serch.min.js', array('jquery'), false, true);
	wp_enqueue_script('tent_comments', get_template_directory_uri() . '/js/serch.js', array('jquery'), false, true );
